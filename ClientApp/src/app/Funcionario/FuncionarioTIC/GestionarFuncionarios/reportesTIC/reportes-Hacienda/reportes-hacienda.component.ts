...
@Component({
  selector: 'app-reportes-hacienda',
  templateUrl: './reportes-hacienda.component.html',
  styleUrls: ['./reportes-hacienda.component.css']
})
export class TICHaciendaReportesComponent implements OnInit {
