...
@Component({
  selector: 'app-reportesa-TIC',
  templateUrl: './reportesa-TIC.component.html',
  styleUrls: ['./reportesa-TIC.component.css']
})
export class ReportesTICComponent implements OnInit {
  ...
  constructor(
    ...
    private serviciosTramite: TramiteService,
