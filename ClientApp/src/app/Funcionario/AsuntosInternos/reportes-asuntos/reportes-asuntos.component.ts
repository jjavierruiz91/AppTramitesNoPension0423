...
@Component({
  selector: 'app-reportes-asuntos',
  templateUrl: './reportes-asuntos.component.html',
  styleUrls: ['./reportes-asuntos.component.css']
})
export class ReportesAsuntosComponent implements OnInit {
