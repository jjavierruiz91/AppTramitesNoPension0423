...
@Component({
  selector: 'app-reportes-hacienda-admin',
  templateUrl: './reportes-hacienda-admin.component.html',
  styleUrls: ['./reportes-hacienda-admin.component.css']
})
export class ADMINHaciendaReportesComponent implements OnInit {
