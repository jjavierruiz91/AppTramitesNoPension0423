...
@Component({
  selector: 'app-tramiteshacienda',
  templateUrl: './TramitesHacienda.component.html',
  styleUrls: ['./TramitesHacienda.component.css']
})
export class TramitesHaciendaComponent implements OnInit {
  ...
  getAllTramites() {
    ...
    this.serviciosTramite.getTramiteGobierno(TramiteSectoriales.Hacienda).subscribe(tramite => this.listaTramites = tramite);
  }
